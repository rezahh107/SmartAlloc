...
For the LLM automation pipeline and 5D scoring policy, see [SmartAlloc LLM Optimized v2.9.3 E2E Automation](docs/llm/SmartAlloc_LLM_Optimized_v2.9.3_E2E-Automation.md#appendix-d--5d-scoring-integration).
